...
void SpyAppSig_AS_send_can_msg_to_server(double dValue);

// Application Signals
extern int AS_is_socket_connected_Index; // sig0
#define AS_is_socket_connected_Get() AS_Get(AS_is_socket_connected_Index)
#define AS_is_socket_connected_Set(dValue) AS_Set(AS_is_socket_connected_Index, dValue)

extern int AS_send_can_msg_to_server_Index; // sig1
#define AS_send_can_msg_to_server_Get() AS_Get(AS_send_can_msg_to_server_Index)
#define AS_send_can_msg_to_server_Set(dValue) AS_Set(AS_send_can_msg_to_server_Index, dValue)
...
extern int MG_neoECU_SIM_Msg_1_HS_CAN_Index;
typedef struct {
    ...
    double Knob_1; /// Min: 0 Max: 65535 Units: 
    WORD Knob_1_raw;
} MG_neoECU_SIM_Msg_1_HS_CAN;
...
#define MG_neoECU_SIM_Msg_1_HS_CAN_Knob_1_PhysicalToRaw(dPhysicalValue) \
    (WORD )CM_SignalPhysicalToRaw(g_uiHandle, 1, MG_neoECU_SIM_Msg_1_HS_CAN_Index, 0, dPhysicalValue);
#define MG_neoECU_SIM_Msg_1_HS_CAN_ClearStats() \
    CM_GetSetValue(g_uiHandle, CM_GETSET_TX_STATS_CLR, MG_neoECU_SIM_Msg_1_HS_CAN_Index, 0)
extern int MG_neoECU_SIM_Msg_2_HS_CAN_Index;
typedef struct {
    GenericMessage MessageData; /// Message Data
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
    double Knob_2; /// Min: 0 Max: 65535 Units: 
    WORD Knob_2_raw;
} MG_neoECU_SIM_Msg_2_HS_CAN;
...
#define MG_neoECU_SIM_Msg_2_HS_CAN_Knob_2_PhysicalToRaw(dPhysicalValue) \
    (WORD )CM_SignalPhysicalToRaw(g_uiHandle, 1, MG_neoECU_SIM_Msg_2_HS_CAN_Index, 0, dPhysicalValue);
#define MG_neoECU_SIM_Msg_2_HS_CAN_ClearStats() \
    CM_GetSetValue(g_uiHandle, CM_GETSET_TX_STATS_CLR, MG_neoECU_SIM_Msg_2_HS_CAN_Index, 0)
extern int MG_neoECU_SIM_Msg_3_HS_CAN_Index;
typedef struct {
    GenericMessage MessageData; /// Message Data
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
    double Knob_3; /// Min: 0 Max: 65535 Units: 
    WORD Knob_3_raw;
} MG_neoECU_SIM_Msg_3_HS_CAN;
...
#define MG_neoECU_SIM_Msg_3_HS_CAN_Knob_3_PhysicalToRaw(dPhysicalValue) \
    (WORD )CM_SignalPhysicalToRaw(g_uiHandle, 1, MG_neoECU_SIM_Msg_3_HS_CAN_Index, 0, dPhysicalValue);
#define MG_neoECU_SIM_Msg_3_HS_CAN_ClearStats() \
    CM_GetSetValue(g_uiHandle, CM_GETSET_TX_STATS_CLR, MG_neoECU_SIM_Msg_3_HS_CAN_Index, 0)
extern int MG_neoECU_SIM_Msg_4_HS_CAN_Index;
typedef struct {
    GenericMessage MessageData; /// Message Data
    MessageStats Statistics; /// Message Statistics
    int iDefaultPeriodMilliseconds; /// Default Message Period
    double Knob_4; /// Min: 0 Max: 65535 Units: 
    WORD Knob_4_raw;
} MG_neoECU_SIM_Msg_4_HS_CAN;
...
#define MG_neoECU_SIM_Msg_4_HS_CAN_Knob_4_PhysicalToRaw(dPhysicalValue) \
    (WORD )CM_SignalPhysicalToRaw(g_uiHandle, 1, MG_neoECU_SIM_Msg_4_HS_CAN_Index, 0, dPhysicalValue);
#define MG_neoECU_SIM_Msg_4_HS_CAN_ClearStats() \
    CM_GetSetValue(g_uiHandle, CM_GETSET_TX_STATS_CLR, MG_neoECU_SIM_Msg_4_HS_CAN_Index, 0)
