...
void __stdcall CM_MG_neoECU_SIM_Msg_1_HS_CAN()
{
    MG_neoECU_SIM_Msg_1_HS_CAN stMyStruct;
    MG_neoECU_SIM_Msg_1_HS_CAN_Init(&stMyStruct);
    SpyMsg_MG_neoECU_SIM_Msg_1_HS_CAN(&stMyStruct);
}

void __stdcall CM_MG_neoECU_SIM_Msg_2_HS_CAN()
{
    MG_neoECU_SIM_Msg_2_HS_CAN stMyStruct;
    MG_neoECU_SIM_Msg_2_HS_CAN_Init(&stMyStruct);
    SpyMsg_MG_neoECU_SIM_Msg_2_HS_CAN(&stMyStruct);
}

void __stdcall CM_MG_neoECU_SIM_Msg_3_HS_CAN()
{
    MG_neoECU_SIM_Msg_3_HS_CAN stMyStruct;
    MG_neoECU_SIM_Msg_3_HS_CAN_Init(&stMyStruct);
    SpyMsg_MG_neoECU_SIM_Msg_3_HS_CAN(&stMyStruct);
}

void __stdcall CM_MG_neoECU_SIM_Msg_4_HS_CAN()
{
    MG_neoECU_SIM_Msg_4_HS_CAN stMyStruct;
    MG_neoECU_SIM_Msg_4_HS_CAN_Init(&stMyStruct);
    SpyMsg_MG_neoECU_SIM_Msg_4_HS_CAN(&stMyStruct);
}

void SpyAppSig_CallAllHandlers()
{
    SpyAppSig_AS_send_can_msg_to_server(0.0);
}

void __stdcall CM_AS_send_can_msg_to_server()
{
    SpyAppSig_AS_send_can_msg_to_server(AS_send_can_msg_to_server_Get());
}
...
void __stdcall CM_ExtensionInit(unsigned int uiHandle, struct stCallBackPointers  * p_stCallBackPointers)
{
    ...
    // messages indexes
     CM_FindIndexForObjectFromName(g_uiHandle,2,L"MG_neoECU_SIM_Msg_1_HS_CAN",&MG_neoECU_SIM_Msg_1_HS_CAN_Index);
     CM_FindIndexForObjectFromName(g_uiHandle,2,L"MG_neoECU_SIM_Msg_2_HS_CAN",&MG_neoECU_SIM_Msg_2_HS_CAN_Index);
     CM_FindIndexForObjectFromName(g_uiHandle,2,L"MG_neoECU_SIM_Msg_3_HS_CAN",&MG_neoECU_SIM_Msg_3_HS_CAN_Index);
     CM_FindIndexForObjectFromName(g_uiHandle,2,L"MG_neoECU_SIM_Msg_4_HS_CAN",&MG_neoECU_SIM_Msg_4_HS_CAN_Index);
    ...
    // app signals indexes
     CM_FindIndexForObjectFromName(g_uiHandle,5,L"AS_is_socket_connected",&AS_is_socket_connected_Index);
     CM_FindIndexForObjectFromName(g_uiHandle,5,L"AS_send_can_msg_to_server",&AS_send_can_msg_to_server_Index);

    CM_RegisterCallback( g_uiHandle,CM_CALLBACKTYPE_MESSAGE_MG, MG_neoECU_SIM_Msg_1_HS_CAN_Index,CM_MG_neoECU_SIM_Msg_1_HS_CAN);
    CM_RegisterCallback( g_uiHandle,CM_CALLBACKTYPE_MESSAGE_MG, MG_neoECU_SIM_Msg_2_HS_CAN_Index,CM_MG_neoECU_SIM_Msg_2_HS_CAN);
    CM_RegisterCallback( g_uiHandle,CM_CALLBACKTYPE_MESSAGE_MG, MG_neoECU_SIM_Msg_3_HS_CAN_Index,CM_MG_neoECU_SIM_Msg_3_HS_CAN);
    CM_RegisterCallback( g_uiHandle,CM_CALLBACKTYPE_MESSAGE_MG, MG_neoECU_SIM_Msg_4_HS_CAN_Index,CM_MG_neoECU_SIM_Msg_4_HS_CAN);
CM_RegisterCallback( g_uiHandle,CM_CALLBACKTYPE_APP_SIGNAL, AS_send_can_msg_to_server_Index,CM_AS_send_can_msg_to_server);
}
...
int AS_is_socket_connected_Index = 0; // sig0
int AS_send_can_msg_to_server_Index = 1; // sig1

int MG_neoECU_SIM_Msg_1_HS_CAN_Index = 0;

void MG_neoECU_SIM_Msg_1_HS_CAN_Init(MG_neoECU_SIM_Msg_1_HS_CAN * pMsg)
{
    ...
    MG_neoECU_SIM_Msg_1_HS_CAN_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    ...
    pMsg->Knob_1 = dValues[0];
    CM_MessageRawInit(g_uiHandle, 1, MG_neoECU_SIM_Msg_1_HS_CAN_Index, nRawValues, 1, &iActualSignalMaxCount);
    pMsg->Knob_1_raw = (WORD)nRawValues[0];
...
void MG_neoECU_SIM_Msg_1_HS_CAN_LoadSignalValuesArray(MG_neoECU_SIM_Msg_1_HS_CAN * pMsg, double *dArray)
{
    dArray[0] = pMsg->Knob_1;
}

void MG_neoECU_SIM_Msg_1_HS_CAN_LoadRawSignalValuesArray(MG_neoECU_SIM_Msg_1_HS_CAN * pMsg, uint64 *nRawValues)
{
    nRawValues[0] = pMsg->Knob_1_raw;
}

int MG_neoECU_SIM_Msg_1_HS_CAN_Transmit(MG_neoECU_SIM_Msg_1_HS_CAN * pMsg)
{
    double dArray[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, pMsg->MessageData.iNumDataBytes))
    {
        CM_UpdateMessageSignalsFromBytes(g_uiHandle, 1, MG_neoECU_SIM_Msg_1_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
        MG_neoECU_SIM_Msg_1_HS_CAN_Init(pMsg);
    }

    MG_neoECU_SIM_Msg_1_HS_CAN_LoadSignalValuesArray(pMsg, dArray);

    return CM_TxFromSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_1_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, dArray, 1);
}

int MG_neoECU_SIM_Msg_1_HS_CAN_Transmit_raw(MG_neoECU_SIM_Msg_1_HS_CAN * pMsg)
{
    uint64 nRawValues[1];
    ...
    MG_neoECU_SIM_Msg_1_HS_CAN_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_TxFromRawSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_1_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, nRawValues, 1);
}

int MG_neoECU_SIM_Msg_1_HS_CAN_UpdateBytesFromSignals(MG_neoECU_SIM_Msg_1_HS_CAN * pMsg)
{
    double dArray[1];

    MG_neoECU_SIM_Msg_1_HS_CAN_LoadSignalValuesArray(pMsg, dArray);

    return CM_UpdateBytesFromSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_1_HS_CAN_Index, dArray, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}

int MG_neoECU_SIM_Msg_1_HS_CAN_UpdateBytesFromRawSignals(MG_neoECU_SIM_Msg_1_HS_CAN * pMsg)
{
    uint64 nRawValues[1];

    MG_neoECU_SIM_Msg_1_HS_CAN_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_UpdateBytesFromRawSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_1_HS_CAN_Index, nRawValues, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}


int MG_neoECU_SIM_Msg_2_HS_CAN_Index = 1;

void MG_neoECU_SIM_Msg_2_HS_CAN_Init(MG_neoECU_SIM_Msg_2_HS_CAN * pMsg)
{
    double dValues[1] = {0.0};
    uint64 nRawValues[1] = {0};
    int iActualSignalMaxCount;
    ...
    CM_MessageGenericInit(g_uiHandle, 1, 
    MG_neoECU_SIM_Msg_2_HS_CAN_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    &pMsg->MessageData.iNumDataBytes, sizeof(pMsg->MessageData.btData),
    &pMsg->iDefaultPeriodMilliseconds, &pMsg->MessageData.iID,
    &pMsg->MessageData.iBitField, &pMsg->MessageData.btData[0],
    &dValues[0], 1, // number of signals when vspy.h was generated
    &iActualSignalMaxCount, &pMsg->MessageData.iTimeStampNanoSecondsHW, &pMsg->MessageData.iTimeStampMillisecondsOS);
    memcpy(pMsg->MessageData.btInitialData, pMsg->MessageData.btData, sizeof(pMsg->MessageData.btData));
    pMsg->Knob_2 = dValues[0];
    CM_MessageRawInit(g_uiHandle, 1, MG_neoECU_SIM_Msg_2_HS_CAN_Index, nRawValues, 1, &iActualSignalMaxCount);
    pMsg->Knob_2_raw = (WORD)nRawValues[0];
    if (g_bUseExtendedIdBit && (pMsg->MessageData.iBitField & ATTR_CAN_29BIT_ID_FRAME))
        pMsg->MessageData.iID = mkExtId(pMsg->MessageData.iID);
}

void MG_neoECU_SIM_Msg_2_HS_CAN_LoadSignalValuesArray(MG_neoECU_SIM_Msg_2_HS_CAN * pMsg, double *dArray)
{
    dArray[0] = pMsg->Knob_2;
}

void MG_neoECU_SIM_Msg_2_HS_CAN_LoadRawSignalValuesArray(MG_neoECU_SIM_Msg_2_HS_CAN * pMsg, uint64 *nRawValues)
{
    nRawValues[0] = pMsg->Knob_2_raw;
}

int MG_neoECU_SIM_Msg_2_HS_CAN_Transmit(MG_neoECU_SIM_Msg_2_HS_CAN * pMsg)
{
    double dArray[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, pMsg->MessageData.iNumDataBytes))
    {
        CM_UpdateMessageSignalsFromBytes(g_uiHandle, 1, MG_neoECU_SIM_Msg_2_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
        MG_neoECU_SIM_Msg_2_HS_CAN_Init(pMsg);
    }

    MG_neoECU_SIM_Msg_2_HS_CAN_LoadSignalValuesArray(pMsg, dArray);

    return CM_TxFromSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_2_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, dArray, 1);
}

int MG_neoECU_SIM_Msg_2_HS_CAN_Transmit_raw(MG_neoECU_SIM_Msg_2_HS_CAN * pMsg)
{
    uint64 nRawValues[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, sizeof(pMsg->MessageData.btData)))
    {
    ...
    MG_neoECU_SIM_Msg_2_HS_CAN_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_TxFromRawSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_2_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, nRawValues, 1);
}

int MG_neoECU_SIM_Msg_2_HS_CAN_UpdateBytesFromSignals(MG_neoECU_SIM_Msg_2_HS_CAN * pMsg)
{
    double dArray[1];

    MG_neoECU_SIM_Msg_2_HS_CAN_LoadSignalValuesArray(pMsg, dArray);

    return CM_UpdateBytesFromSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_2_HS_CAN_Index, dArray, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}

int MG_neoECU_SIM_Msg_2_HS_CAN_UpdateBytesFromRawSignals(MG_neoECU_SIM_Msg_2_HS_CAN * pMsg)
{
    uint64 nRawValues[1];

    MG_neoECU_SIM_Msg_2_HS_CAN_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_UpdateBytesFromRawSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_2_HS_CAN_Index, nRawValues, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}


int MG_neoECU_SIM_Msg_3_HS_CAN_Index = 2;

void MG_neoECU_SIM_Msg_3_HS_CAN_Init(MG_neoECU_SIM_Msg_3_HS_CAN * pMsg)
{
    double dValues[1] = {0.0};
    uint64 nRawValues[1] = {0};
    int iActualSignalMaxCount;
    ...
    CM_MessageGenericInit(g_uiHandle, 1, 
    MG_neoECU_SIM_Msg_3_HS_CAN_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    &pMsg->MessageData.iNumDataBytes, sizeof(pMsg->MessageData.btData),
    &pMsg->iDefaultPeriodMilliseconds, &pMsg->MessageData.iID,
    &pMsg->MessageData.iBitField, &pMsg->MessageData.btData[0],
    &dValues[0], 1, // number of signals when vspy.h was generated
    &iActualSignalMaxCount, &pMsg->MessageData.iTimeStampNanoSecondsHW, &pMsg->MessageData.iTimeStampMillisecondsOS);
    memcpy(pMsg->MessageData.btInitialData, pMsg->MessageData.btData, sizeof(pMsg->MessageData.btData));
    pMsg->Knob_3 = dValues[0];
    CM_MessageRawInit(g_uiHandle, 1, MG_neoECU_SIM_Msg_3_HS_CAN_Index, nRawValues, 1, &iActualSignalMaxCount);
    pMsg->Knob_3_raw = (WORD)nRawValues[0];
    if (g_bUseExtendedIdBit && (pMsg->MessageData.iBitField & ATTR_CAN_29BIT_ID_FRAME))
        pMsg->MessageData.iID = mkExtId(pMsg->MessageData.iID);
}

void MG_neoECU_SIM_Msg_3_HS_CAN_LoadSignalValuesArray(MG_neoECU_SIM_Msg_3_HS_CAN * pMsg, double *dArray)
{
    dArray[0] = pMsg->Knob_3;
}

void MG_neoECU_SIM_Msg_3_HS_CAN_LoadRawSignalValuesArray(MG_neoECU_SIM_Msg_3_HS_CAN * pMsg, uint64 *nRawValues)
{
    nRawValues[0] = pMsg->Knob_3_raw;
}

int MG_neoECU_SIM_Msg_3_HS_CAN_Transmit(MG_neoECU_SIM_Msg_3_HS_CAN * pMsg)
{
    double dArray[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, pMsg->MessageData.iNumDataBytes))
    {
        CM_UpdateMessageSignalsFromBytes(g_uiHandle, 1, MG_neoECU_SIM_Msg_3_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
        MG_neoECU_SIM_Msg_3_HS_CAN_Init(pMsg);
    }

    MG_neoECU_SIM_Msg_3_HS_CAN_LoadSignalValuesArray(pMsg, dArray);

    return CM_TxFromSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_3_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, dArray, 1);
}

int MG_neoECU_SIM_Msg_3_HS_CAN_Transmit_raw(MG_neoECU_SIM_Msg_3_HS_CAN * pMsg)
{
    uint64 nRawValues[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, sizeof(pMsg->MessageData.btData)))
    {
    ...
    MG_neoECU_SIM_Msg_3_HS_CAN_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_TxFromRawSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_3_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, nRawValues, 1);
}

int MG_neoECU_SIM_Msg_3_HS_CAN_UpdateBytesFromSignals(MG_neoECU_SIM_Msg_3_HS_CAN * pMsg)
{
    double dArray[1];

    MG_neoECU_SIM_Msg_3_HS_CAN_LoadSignalValuesArray(pMsg, dArray);

    return CM_UpdateBytesFromSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_3_HS_CAN_Index, dArray, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}

int MG_neoECU_SIM_Msg_3_HS_CAN_UpdateBytesFromRawSignals(MG_neoECU_SIM_Msg_3_HS_CAN * pMsg)
{
    uint64 nRawValues[1];

    MG_neoECU_SIM_Msg_3_HS_CAN_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_UpdateBytesFromRawSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_3_HS_CAN_Index, nRawValues, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}


int MG_neoECU_SIM_Msg_4_HS_CAN_Index = 3;

void MG_neoECU_SIM_Msg_4_HS_CAN_Init(MG_neoECU_SIM_Msg_4_HS_CAN * pMsg)
{
    double dValues[1] = {0.0};
    uint64 nRawValues[1] = {0};
    int iActualSignalMaxCount;
    ...
    CM_MessageGenericInit(g_uiHandle, 1, 
    MG_neoECU_SIM_Msg_4_HS_CAN_Index, &pMsg->Statistics, &pMsg->MessageData.iNetwork, 
    &pMsg->MessageData.iNumDataBytes, sizeof(pMsg->MessageData.btData),
    &pMsg->iDefaultPeriodMilliseconds, &pMsg->MessageData.iID,
    &pMsg->MessageData.iBitField, &pMsg->MessageData.btData[0],
    &dValues[0], 1, // number of signals when vspy.h was generated
    &iActualSignalMaxCount, &pMsg->MessageData.iTimeStampNanoSecondsHW, &pMsg->MessageData.iTimeStampMillisecondsOS);
    memcpy(pMsg->MessageData.btInitialData, pMsg->MessageData.btData, sizeof(pMsg->MessageData.btData));
    pMsg->Knob_4 = dValues[0];
    CM_MessageRawInit(g_uiHandle, 1, MG_neoECU_SIM_Msg_4_HS_CAN_Index, nRawValues, 1, &iActualSignalMaxCount);
    pMsg->Knob_4_raw = (WORD)nRawValues[0];
    if (g_bUseExtendedIdBit && (pMsg->MessageData.iBitField & ATTR_CAN_29BIT_ID_FRAME))
        pMsg->MessageData.iID = mkExtId(pMsg->MessageData.iID);
}

void MG_neoECU_SIM_Msg_4_HS_CAN_LoadSignalValuesArray(MG_neoECU_SIM_Msg_4_HS_CAN * pMsg, double *dArray)
{
    dArray[0] = pMsg->Knob_4;
}

void MG_neoECU_SIM_Msg_4_HS_CAN_LoadRawSignalValuesArray(MG_neoECU_SIM_Msg_4_HS_CAN * pMsg, uint64 *nRawValues)
{
    nRawValues[0] = pMsg->Knob_4_raw;
}

int MG_neoECU_SIM_Msg_4_HS_CAN_Transmit(MG_neoECU_SIM_Msg_4_HS_CAN * pMsg)
{
    double dArray[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, pMsg->MessageData.iNumDataBytes))
    {
        CM_UpdateMessageSignalsFromBytes(g_uiHandle, 1, MG_neoECU_SIM_Msg_4_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
        MG_neoECU_SIM_Msg_4_HS_CAN_Init(pMsg);
    }

    MG_neoECU_SIM_Msg_4_HS_CAN_LoadSignalValuesArray(pMsg, dArray);

    return CM_TxFromSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_4_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, dArray, 1);
}

int MG_neoECU_SIM_Msg_4_HS_CAN_Transmit_raw(MG_neoECU_SIM_Msg_4_HS_CAN * pMsg)
{
    uint64 nRawValues[1];
    if (memcmp(pMsg->MessageData.btData, pMsg->MessageData.btInitialData, sizeof(pMsg->MessageData.btData)))
    {
    ...
    MG_neoECU_SIM_Msg_4_HS_CAN_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_TxFromRawSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_4_HS_CAN_Index, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes, pMsg->MessageData.iNetwork, nRawValues, 1);
}

int MG_neoECU_SIM_Msg_4_HS_CAN_UpdateBytesFromSignals(MG_neoECU_SIM_Msg_4_HS_CAN * pMsg)
{
    double dArray[1];

    MG_neoECU_SIM_Msg_4_HS_CAN_LoadSignalValuesArray(pMsg, dArray);

    return CM_UpdateBytesFromSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_4_HS_CAN_Index, dArray, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}

int MG_neoECU_SIM_Msg_4_HS_CAN_UpdateBytesFromRawSignals(MG_neoECU_SIM_Msg_4_HS_CAN * pMsg)
{
    uint64 nRawValues[1];

    MG_neoECU_SIM_Msg_4_HS_CAN_LoadRawSignalValuesArray(pMsg, nRawValues);

    return CM_UpdateBytesFromRawSignals(g_uiHandle, 1, MG_neoECU_SIM_Msg_4_HS_CAN_Index, nRawValues, 1, pMsg->MessageData.btData, pMsg->MessageData.iNumDataBytes);
}
